...
if (exportloc==1){
        CONV_exportbase <- file.path(DirTable_yr$Export_Dir, var) #set to export directory
}
else if (exportloc==0){
        CONV_exportbase <- file.path(DirTable_yr$Region_Export_Dir, var) #set to region export directory
}
